...
The current public build is **v1.1.0-beta.5**. It is a beta of the new modular
...
- [Product release manifest](https://github.com/openagent-uno/openagent/releases/download/v1.1.0-beta.5/product-release-manifest.json)
