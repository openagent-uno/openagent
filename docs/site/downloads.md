...
The current public build is **v1.1.0-beta.10**. It is a beta of the new modular
...
- [OpenAgent Core v1.1.0-beta.5](https://github.com/openagent-uno/openagent-core/releases/tag/v1.1.0-beta.5)
  — kernel, SDK, storage and optional module wheels.
- [OpenAgent Tools v1.0.0-beta.3](https://github.com/openagent-uno/openagent-tools/releases/tag/v1.0.0-beta.3)
...
- [Product release manifest](https://github.com/openagent-uno/openagent/releases/download/v1.1.0-beta.10/product-release-manifest.json)
