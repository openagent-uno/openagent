...
releases = (
    ("openagent-uno/openagent", "v1.1.0-beta.7", "product-release-manifest.json"),
    ("openagent-uno/openagent-core", "v1.1.0-beta.3", "manifest.json"),
...
if [ "$PRODUCT" = "server" ]; then
    DIST="openagent-framework==1.1.0b7"
    COMMAND="openagent"
else
    DIST="openagent-cli==1.1.0b7"
