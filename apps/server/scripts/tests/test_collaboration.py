...
from openagent_server.gateway.collaboration import Collaboration, CommandReply
from openagent_server.gateway.collaboration_access import authorize
...
class CollaborationTests(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        ...
        from openagent_server.gateway.collaboration_members import handle_members
