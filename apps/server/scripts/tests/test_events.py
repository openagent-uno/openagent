...
async def t_webhook_auth_github(ctx: TestContext) -> None:
    from openagent_core.memory.db import MemoryDB
    from openagent_core.core.event_secret import make_secret_material
    from openagent_server.gateway.webhook_auth import authenticate, WebhookAuthError, extract_external_id
...
async def t_webhook_auth_generic(ctx: TestContext) -> None:
    from openagent_core.memory.db import MemoryDB
    from openagent_core.core.event_secret import make_secret_material
    from openagent_server.gateway.webhook_auth import authenticate, WebhookAuthError
...
async def t_event_cancel_not_failed(ctx: TestContext) -> None:
    ...
    import openagent_server.core.event_dispatcher as ed
