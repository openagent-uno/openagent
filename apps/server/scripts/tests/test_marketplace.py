...
async def t_synth_requirements(ctx: TestContext) -> None:
    from openagent_server.gateway.api.marketplace import _synthesise_requirements
...
async def t_runtime_inferred(ctx: TestContext) -> None:
    ...
    from openagent_server.gateway.api.marketplace import (
...
async def t_install_npx(ctx: TestContext) -> None:
    from openagent_server.gateway.api.marketplace import _build_install_payload
...
async def t_install_named_args(ctx: TestContext) -> None:
    from openagent_server.gateway.api.marketplace import _resolve_arg_values
...
async def t_default_name(ctx: TestContext) -> None:
    from openagent_server.gateway.api.marketplace import _default_install_name
...
async def t_cache_lru(ctx: TestContext) -> None:
    import time
    from openagent_server.gateway.api import marketplace as mp
