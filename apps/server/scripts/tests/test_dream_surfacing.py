...
async def t_list_include_builtin(ctx: TestContext) -> None:
    from openagent_server.gateway.api.scheduled_tasks import handle_list
...
async def t_get_and_runs_readable(ctx: TestContext) -> None:
    from openagent_server.gateway.api.scheduled_tasks import handle_get, handle_runs_list
...
async def t_builtin_mutations_rejected(ctx: TestContext) -> None:
    from openagent_server.gateway.api.scheduled_tasks import (
