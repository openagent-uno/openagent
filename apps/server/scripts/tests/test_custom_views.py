...
async def t_oaui_compiler(ctx: TestContext) -> None:
    from openagent_dashboards.compiler import OAUIValidationError, compile_oaui
...
async def t_custom_view_migration_bundle(ctx: TestContext) -> None:
    from openagent_dashboards.migration import MIGRATION_ID, ensure_custom_views_storage, migration_checksum
    ...
    with tempfile.TemporaryDirectory(prefix="oa-ui-schema-") as raw:
        ...
        try:
            ...
            from openagent_dashboards.bundles import BundleEvidence
...
async def t_custom_view_migration_rollback(ctx: TestContext) -> None:
    import openagent_dashboards.migration as migration
...
async def t_custom_view_repository(ctx: TestContext) -> None:
    from openagent_dashboards.repository import CustomViewNotFound, CustomViewRepository
...
async def t_custom_view_lifecycle_blocks_work(ctx: TestContext) -> None:
    from openagent_dashboards.repository import CustomViewImmutable
    from openagent_dashboards.service import CustomViewService
...
async def t_custom_view_subscription_boundaries(ctx: TestContext) -> None:
    from openagent_dashboards.repository import CustomViewRateLimited, CustomViewRepository
    from openagent_dashboards.runtime import CustomViewRuntime
    from openagent_dashboards.service import CustomViewService
...
async def t_custom_view_action_process_cleanup(ctx: TestContext) -> None:
    ...
    from openagent_dashboards.repository import CustomViewError
    from openagent_dashboards.service import CustomViewService
...
async def t_custom_view_revision_runtime(ctx: TestContext) -> None:
    from openagent_dashboards.repository import CustomViewNotFound
    from openagent_dashboards.service import CustomViewService
...
async def t_custom_view_output_schema(ctx: TestContext) -> None:
    from openagent_dashboards.repository import CustomViewInputError
    from openagent_dashboards.service import CustomViewService
...
async def t_ui_manager_bundle_preflight(ctx: TestContext) -> None:
    ...
    from openagent_dashboards.tools import adapters
...
async def t_custom_view_rest(ctx: TestContext) -> None:
    ...
    from openagent_server.gateway.api import custom_views as api
...
async def t_migration_fk_check_is_scoped(ctx: TestContext) -> None:
    ...
    """
    from openagent_dashboards.migration import (
