...
async def t_supports_gate(_ctx: TestContext) -> None:
    from openagent_core.voice.tts_streaming import supports_token_stream
...
async def t_no_ws_returns_quickly(_ctx: TestContext) -> None:
    ...
    from openagent_core.voice.tts_streaming import synthesize_token_stream
...
async def t_ws_full_roundtrip(_ctx: TestContext) -> None:
    ...
    try:
        ...
        from openagent_server.channels import tts_streaming
