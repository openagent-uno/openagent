...
async def t_list_users(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_list_users
...
async def t_list_agents(ctx: TestContext) -> None:
    ...
    from openagent_server.gateway.api.network import handle_list_agents
...
async def t_list_invitations(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_list_invitations
...
async def t_mint_new_handle(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_mint_invitation
...
async def t_revoke(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_mint_invitation, handle_revoke_invitation
...
async def t_patch_user_status(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_patch_user
    from openagent_identity.coordinator.store import CoordinatorStore
...
async def t_delete_user(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_delete_user
    from openagent_identity.coordinator.store import CoordinatorStore
...
async def t_patch_agent_label(ctx: TestContext) -> None:
    from openagent_server.gateway.api.network import handle_patch_agent
    from openagent_identity.coordinator.store import CoordinatorStore
...
async def t_delete_self_agent_blocked(ctx: TestContext) -> None:
    ...
    from openagent_server.gateway.api.network import handle_delete_agent
