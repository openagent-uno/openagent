...
from openagent_identity import identity as identity_module
...
async def t_gateway_cert_is_peer_bound(ctx: TestContext) -> None:
    ...
    from openagent_identity.auth.device_cert import issue_cert
...
async def t_capability_ws_rejects_synthetic_http_token(ctx: TestContext) -> None:
    ...
    from openagent_identity.auth.middleware import NetworkAuthState, make_auth_middleware
    import openagent_identity.transport.aiohttp_iroh_site as transport
