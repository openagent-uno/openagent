...
async def t_atomic_preserve_live_and_redacted(ctx: TestContext) -> None:
    import openagent_server.core.agent_identity as identity
...
async def t_owner_acl(ctx: TestContext) -> None:
    from openagent_product_config.agent_identity import (
...
async def t_revision_conflict(ctx: TestContext) -> None:
    from openagent_product_config.agent_identity import AgentIdentityConflict, AgentIdentityService
...
async def t_rest_contract(ctx: TestContext) -> None:
    from openagent_server.gateway.api import agent_identity as api
...
async def t_legacy_config_routes_delegate(ctx: TestContext) -> None:
    from openagent_server.gateway.api import config as config_api
