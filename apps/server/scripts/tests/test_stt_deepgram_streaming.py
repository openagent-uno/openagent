...
async def t_partial_then_final(_ctx: TestContext) -> None:
    ...
    from openagent_server.channels import stt_deepgram
...
async def t_no_websockets_no_op(_ctx: TestContext) -> None:
    ...
    from openagent_server.channels.stt_deepgram import DeepgramStreamingSTT
...
async def t_resolve_picks_deepgram(_ctx: TestContext) -> None:
    ...
    from openagent_server.channels import voice as _voice
