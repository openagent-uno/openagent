...
async def t_builtin_default_schedules_do_not_collide(_ctx: TestContext) -> None:
    ...
    from openagent_server.server import (
...
async def t_cost_dedup_name_matcher(_ctx: TestContext) -> None:
    from openagent_server.server import _is_custom_cost_observability_name
...
async def t_audit_name_matcher(_ctx: TestContext) -> None:
    from openagent_server.server import _is_custom_escalation_audit_name
