...
async def handle_catalog(request: web.Request) -> web.Response:
    ...
    from aiohttp import web as _web
    from openagent_core.models.catalog import get_model_pricing, iter_configured_models
    from openagent_core.models.media_capabilities import input_modalities_for
...
def _shape_model(row: dict[str, Any]) -> dict[str, Any]:
    ...
    from openagent_core.voice.tts import DEFAULT_VOICE_BY_VENDOR
