...
from openagent_core.core.builtin_tasks import BUILTIN_TASK_NAMES
...
async def handle_update(request):
    from aiohttp import web
    from openagent_core.memory.schedule import validate_schedule_expression, validate_timezone
