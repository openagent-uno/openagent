...
Every handler DELEGATES to :mod:`openagent_core.mcp.servers.skills.handlers`. That is
...
def _registry():
    from openagent_core.mcp.servers.skills.handlers import _registry as build
...
async def handle_search(request):
    ...
    from openagent_core.mcp.servers.skills.handlers import skill_search
...
async def handle_get(request):
    ...
    from openagent_core.mcp.servers.skills.handlers import skill_view
