...
from openagent_support import support_attachments, support_context, support_semantics, support_turn, support_progress, support_guidance, support_voice
from openagent_support.support_billing import billing_payload, explicit_premium
from openagent_support.support_email import receipt_request, without_support_echo
...
async def _call_first(
    ...
    *,
    ...
    raw = await call_tool(pool, server, tool, actual_args)
    result = (
...
async def run(
    *,
    ...
    from openagent_support import support_delivery_receipts
