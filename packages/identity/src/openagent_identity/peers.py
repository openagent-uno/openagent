...
from openagent_identity.auth.device_cert import (
...
async def handle_join(request: web.Request) -> web.Response:
    ...
    """
    from openagent_identity.client.login import agent_login, fetch_network_info
...
async def handle_peer_chat(request: web.Request) -> web.Response:
    ...
    from openagent_identity.client.session import AgentDialer, LoopbackProxy
