...
the conversation (``openagent_core.core.context_report.build_context_report``): model,
...
# terminal" surface. See :mod:`openagent_server.gateway.terminals`. ``data`` fields
...
from openagent_server.gateway.commands import COMMANDS
